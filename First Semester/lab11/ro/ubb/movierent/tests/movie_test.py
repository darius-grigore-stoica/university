...
class TestMovieRepository(unittest.TestCase):
    def setUp(self):
        ...
        movie1 = Movie("1", "a", "b", "c", "1")
        movie2 = Movie("2", "aa", "bb", "cc", "2")
        movie3 = Movie("3", "aaa", "bbb", "ccc", "3")
        self.movieRepo.add(movie1)
        self.movieRepo.add(movie2)
        self.movieRepo.add(movie3)

    def test_findAll(self):
        self.assertTrue(len(self.movieRepo.findAll()) == 3, "Nu s-au gasit corect filmele din lista!")

    def test_add(self):
        movie = Movie("4", "Once Upon A Time", "lorem25", "Action", "2")
