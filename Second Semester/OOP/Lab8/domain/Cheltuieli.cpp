...
ostream &operator<<(ostream &os, Cheltuieli &c) {
    os << "Nr. Apartament: " << c.nrApartament << endl;
    os << "Suma: " << c.suma << endl;
    os << "Tipul: " << (c.tipul) << endl;
    return os;
}
...
istream &operator>>(istream &is, Cheltuieli &c) {
    ...
    cout << "Suma:\n";
    is >> c.suma;
    char *tipul = new char[50];
    cout << "Tipul (i.e. gaz, apa):\n";
    cin.ignore();
    cin.getline(tipul, 50);
    c.setTipul(tipul);
    return is;
}
